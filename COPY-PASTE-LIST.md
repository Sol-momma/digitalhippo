# ReuseMate - A Modern Fullstack E-Commerce Marketplace for Digital Products

Built with the Next.js 14 App Router, tRPC, TypeScript, Payload & Tailwind

![Project Image](https://github.com/joschan21/ReuseMate/blob/master/public/thumbnail.jpg)
...
<Html>
    <Head />
    <Preview>Your ReuseMate Receipt</Preview>
    ...
    <Container style={container}>
        ...
        Copyright © 2023 ReuseMate Inc. <br />{' '}
...
<Body style={main}>
    ...
    <Text style={paragraph}>
        Welcome to ReuseMate, the marketplace for high quality digital
...
export function constructMetadata({
  title = 'ReuseMate - the marketplace for digital assets',
  description = 'ReuseMate is an open-source marketplace for high-quality digital goods.',
  image = '/thumbnail.png',
  icons = '/favicon.ico',
  noIndex = false,
}: {
  ...
  return {
    ...
    icons,
    metadataBase: new URL('https://ReuseMate.up.railway.app'),
    ...(noIndex && {
      robots: {
        index: false,
        follow: false,
